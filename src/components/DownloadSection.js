    ...
    <section id="download" className="py-12 bg-[var(--color-background)]">
      <div className="container-custom">
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          <h2 className="text-3xl font-bold text-[var(--color-primary)] mb-4 font-montserrat">
          ...
          <a
            href="/package.zip"
            download
            className="inline-flex items-center px-6 py-3 bg-[var(--color-primary)] text-white rounded-lg hover:bg-[var(--color-primary-light)] transition-colors gap-2 text-lg font-semibold"
          >
