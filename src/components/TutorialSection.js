...
const TutorialSection = () => {
  return (
    <section id="installation" className="py-12 bg-white">
      <div className="container-custom">
        ...
        <div className="space-y-8">
          ...
          <div className="bg-gray-50 p-8 rounded-lg border border-gray-200">
            ...
            <p className="text-[var(--color-secondary)] mb-4">
              Navigate to <a href="https://www.sephora.com" className="important-text" target="_blank" rel="noopener noreferrer">Sephora website</a> and select a product. Once you have opened the page of a specific product, click the Extension icon on the upper right of your screen to open DeepBeauty AI. It will then load a few different potential dupes of the current product you're viewing.
            </p>
